<?php
/**
 * Простое создание статьи без проверки прав
 */
...
if ($post_id && !is_wp_error($post_id)) {
    ...
    update_post_meta($post_id, '_bsag_keyword', 'стоимость банковской гарантии');
    update_post_meta($post_id, '_bsag_word_count', 2500);
    update_post_meta($post_id, '_bsag_min_words', 2500);
    update_post_meta($post_id, '_bsag_generated_at', current_time('mysql'));
    
    // SEO мета-данные
    update_post_meta($post_id, '_yoast_wpseo_focuskw', 'стоимость банковской гарантии');
    update_post_meta($post_id, '_yoast_wpseo_metadesc', 'Узнайте стоимость банковской гарантии в 2025 году. Калькулятор премии, факторы ценообразования, сравнение тарифов банков. Как сэкономить на гарантии - экспертные советы.');
    update_post_meta($post_id, '_yoast_wpseo_title', 'Стоимость банковской гарантии: калькулятор и расчёт премии 2025 | BizFin Pro');
...
function generate_article_content() {
    ...
    <section class="intro">
        ...
        <p><strong>Стоимость банковской гарантии</strong> — это премия, которую заявитель платит банку за выдачу гарантийного обязательства. Размер премии зависит от суммы гарантии, срока действия, типа гарантии и финансового состояния принципала.</p>
