<?php
/**
 * Обновление новой статьи правильным контентом
 */
...
// Правильный HTML контент (только body контент без CSS)
$article_content = '
<!-- Вводная секция -->
...
if ($updated && !is_wp_error($updated)) {
    ...
    update_post_meta($post_id, '_yoast_wpseo_title', 'Зачем нужна банковская гарантия на возврат аванса: полное руководство');
    ...
    echo "✅ Новая статья успешно создана!\n";
    ...
    echo "✅ CSS код НЕ включен в контент\n";
    echo "✅ Только HTML контент для отображения\n";
    ...
    echo "❌ Ошибка создания статьи: " . (is_wp_error($updated) ? $updated->get_error_message() : 'Неизвестная ошибка') . "\n";
}
?>
