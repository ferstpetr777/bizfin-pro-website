...
echo "=== ПЕРЕМЕЩЕНИЕ АЛФАВИТНЫХ БЛОКОВ В НАЧАЛО СТАТЕЙ ===\n\n";
...
foreach ($posts as $post_id) {
    ...
    echo "✓ Перемещен алфавитный блок в начало статьи ID $post_id ($post_date): '$post_title'\n";
    $updated_count++;
}
