...
echo "=== ИСПРАВЛЕНИЕ ИЗОБРАЖЕНИЙ БЛОГА ===\n\n";
...
if ($custom_logo_id) {
    ...
    // Проверим текущий файл
    $current_file = get_post_meta($custom_logo_id, '_wp_attached_file', true);
    ...
    if (file_exists($full_path)) {
        echo "WebP файл найден: " . $webp_file . "\n";
