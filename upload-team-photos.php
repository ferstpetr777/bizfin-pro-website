<?php
/**
 * Скрипт для загрузки фотографий команды в медиатеку WordPress
...
echo "Начинаем загрузку фотографий команды в медиатеку WordPress...\n";
